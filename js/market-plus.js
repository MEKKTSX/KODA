// 🚀 KODA Market Plus Module (Phase 3 - Stable TradingView Integration)
window.KodaMarketPlus = {
    ...
    initDynamics: () => {
        ...
        // 📌 บังคับรีเฟรชกราฟทุกๆ 15 นาที (900000 ms) 
        // เพื่อให้ตรงกับรอบการอัปเดตข้อมูลของฝั่ง TradingView
        setInterval(() => {
            window.KodaMarketPlus.injectTradingViewWidget();
        }, 900000); 
    }
